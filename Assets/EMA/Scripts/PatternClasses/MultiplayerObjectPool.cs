...
{ 
    [System.Serializable]
    public class MultiplayerObjectPool
    {
        ...
        public void CreatePool()
        {
            ...
            for (int i = 0; i < hmObjCreateAtFirst; i++) {
              ...
              /*  var obj = PhotonNetwork.Instantiate(pooledObjectPrefab.name, parentTransform.position,Quaternion.identity);
                obj.SetActive(false);
        ...
        public GameObject GetPooledObject()
        {
          ...
          //  var newObj = PhotonNetwork.Instantiate(pooledObjectPrefab.name, parentTransform.position,Quaternion.identity);
